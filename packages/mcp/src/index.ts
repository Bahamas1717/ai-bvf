...
console.error(`aibvf-mcp v${VERSION} ready on stdio - 9 tools: score_initiative, score_portfolio, recommend_improvements, calculate_pace_layer_drag, validate_portfolio, get_benchmark, list_taxonomy, diagnose_process, infer_readiness`);
